...
-- 07-add-item-porachki-columns.sql): runs only when the table exists in
-- DATABASE() and the column is missing. porachki_l/porachki_no are regional cart
-- headers (no-op against imartap). Re-running is a no-op.
