-- =============================================================================
-- 18-add-cart_promo_codes-discount_value.sql  (old/ path)
-- =============================================================================
-- Identical SQL to new/19-add-cart_promo_codes-discount_value.sql.
...
--
-- Run against: every REGIONAL DB that has cart_promo_codes (created by old/14).
-- NOT imartap (the original imartap cart_promo_codes is dropped by old/17;
-- this column goes on the regional copy only).
--
